...
const OrderDetails = () => {
    return (
        <div className={styles.root}>
            <p className={classNames("text text_type_digits-large", styles.orderId)}>{data.order_id}</p>
            <p className={classNames("text text_type_main-medium", styles.orderIdText)}>Идентификатор заказа</p>
